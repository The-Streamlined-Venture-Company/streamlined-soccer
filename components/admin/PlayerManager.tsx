    ...
    <div className="w-full bg-slate-900/80 backdrop-blur-xl border border-white/5 rounded-3xl p-4 md:p-6 shadow-2xl">
      ...
      <div className="flex flex-wrap gap-2 mb-4">
        <input
          ...
          placeholder="Search..."
          className="flex-1 min-w-[150px] bg-slate-950 border border-slate-800 rounded-lg px-3 py-2 text-sm text-white focus:border-emerald-500/50 focus:outline-none"
        />
        <select
          value={filterStatus}
        ...
        <button
          ...
          className="px-3 py-2 bg-emerald-600 hover:bg-emerald-500 text-white rounded-lg text-xs font-bold uppercase transition-all"
        >
          + Add
        </button>
        <button
          onClick={refresh}
          className="px-3 py-2 bg-slate-800 hover:bg-slate-700 text-white rounded-lg text-xs font-bold uppercase transition-all"
        >
          ↻
        </button>
      </div>
