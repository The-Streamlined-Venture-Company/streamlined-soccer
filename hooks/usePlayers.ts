    ...
    async (player: PlayerInsert): Promise<Player | null> => {
      ...
      if (useSupabase && supabase) {
        ...
        const newPlayer: Player = {
          ...
          preferred_team: player.preferred_team || 'any',
          aliases: player.aliases || [],
          notes: player.notes || null,
          whatsapp_phone: player.whatsapp_phone || null,
          whatsapp_jid: player.whatsapp_jid || null,
          whatsapp_push_name: player.whatsapp_push_name || null,
          discovered_via: player.discovered_via || 'manual',
          created_by: null,
          created_at: new Date().toISOString(),
          updated_at: new Date().toISOString(),
        };
