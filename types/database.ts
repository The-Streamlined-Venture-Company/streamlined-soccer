    ...
    Tables: {
      ...
      session_schedules: {
        Row: {
          ...
          confirmation_destination: 'off' | 'organiser_dm';
          callout_destination: 'off' | 'group' | 'organiser_dm';
          nudge_destination: 'off' | 'group' | 'organiser_dm';
          auto_cancel_destination: 'off' | 'group' | 'organiser_dm';
