    ...
    <>
      ...
      {!isOpen && (
        <button
          ...
          className="fixed bottom-24 right-6 z-40 w-14 h-14 rounded-full bg-emerald-500 hover:bg-emerald-400 text-white shadow-lg transition-all hover:scale-105 active:scale-95 flex items-center justify-center mb-safe touch-target-lg"
        >
